                                ...
                                <td class="w-40">
                                    <div class="flex">
                                        <div class="w-10 h-10 image-fit zoom-in">
                                            <img alt="Icewall Tailwind HTML Admin Template" class="tooltip rounded-full"
...
<script type="text/javascript">
    ...
    var totals = {{ Js:: from($data) }};
     ...
     localStorage.setItem('_label',JSON.stringify(labels));
     localStorage.setItem('_total', JSON.stringify(totals));
