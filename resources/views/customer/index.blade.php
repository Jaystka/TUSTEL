...
<h2 class="intro-y text-lg font-medium mt-10">Daftar Pelanggan</h2>
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        <a class="btn btn-primary shadow-md mr-2" href="{{ route('customer.create') }}">Tambah Pelanggan</a>
        <div class="dropdown">
                ...
                <tr class="intro-x">
                    ...
                    <td class="table-report__action w-56">
                        <div class="flex justify-center items-center">
                            ...
                            <form action="{{ route('customer.destroy', $customer->id_customer) }}" method="POST" type="button" onsubmit="return confirm('Delete?')">
                                @csrf
                                @method('DELETE')
